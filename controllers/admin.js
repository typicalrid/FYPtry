...
exports.postChnageStatus = (req, res, next) => {
    ...
    if (req.body.click == "Approve") {
        ...
        " AND person = " + mysql.escape(req.body.want)
...
exports.getAddDest = (req, res, next) => {
    res.render('admin/AddDest', { msg: "", err: "" });
}

//add new destination info
exports.postAddDest = (req, res, next) => {
    ...
    new formidable.IncomingForm().parse(req)
        ...
        .on('fileBegin', function (name, file) {
            ...
            if (fileType == 'jpg' || fileType == 'png' || fileType == 'jpeg') {
                ...
                wrong = 1;
                res.render('admin/AddDest', { msg: "", err: "Wrong File type" });
            }
        })
        .on('aborted', () => {
            ...
            if (wrong == 1) {
                ...
                connectDB.query(data, (err, result) => {
                    ...
                    if (err) {
                        ...
                        res.render('admin/AddDest', { msg: "Data Insert Successfuly", err: "" });
                    }
                });
            }
        })
